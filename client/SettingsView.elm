                ...
                , div [ class "offset-md-5 offset-lg-2 col-md-7 col-lg-10" ]
                    ...
                    , div [ id "key-settings", class "setting-group" ]
                        ...
                        , p [ style "font-size" "14px" ]
                            ...
                            , text "によってエンドツーエンド暗号化されています。秘密鍵は各ユーザーの端末のみに保存されるため，サーバー管理者でさえもエンドツーエンド暗号化された内容を読むことができません。同じユーザーが他の端末で使用する場合は，下記より秘密鍵を書き出してから他の端末で読み込むか，あるいは一時的にサーバーに秘密鍵を預けてから他の端末でログインすることで利用が可能になります。なお，送信日時，送信ユーザーIDなどのメタデータ，プロフィール情報はサーバー上に暗号化して保存され，サーバー管理者が読み取り可能です。"
                            ]
                        , div [ class "row" ]
